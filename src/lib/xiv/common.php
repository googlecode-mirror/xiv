...
if (!is_writable(TM_TEMP_DIR)) {
	trigger_error("Please make sure \"".TM_TEMP_DIR."\" is writable (chmod 777).", E_USER_WARNING);
}
if (!is_writable(TM_DATA_DIR)) {
	trigger_error("Please make sure \"".TM_DATA_DIR."\" is writable (chmod 777).", E_USER_WARNING);
}
