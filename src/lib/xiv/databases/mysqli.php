 ...
 * @copyright       Copyright (c) 2007-2008, Jorge de Jesus Medrano Rodriguez
	...
	function bind() {
		...
		if (isset($cond)) {
			...
			if ((substr_count($cond, '?')) == $argc-1) {
				...
				trigger_error('Unmatched arguments.', E_USER_ERROR);
			}
		} else {
			trigger_error('You must provide a prototype!.', E_USER_ERROR);
		}
	}
